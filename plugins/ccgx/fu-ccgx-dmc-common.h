...
typedef enum {
	...
	DMC_UPDATE_MODEL_DOWNLOAD_TIRGGER,
...
typedef struct __attribute__((packed)) {
	...
	/* model feild indicates the type of the firmware upgrade status
	* 0 - online/offline
	* 1 - Online model
...
gchar   *fu_ccgx_dmc_version_to_string (guint32 val);
gchar   *fu_ccgx_dmc_update_model_to_string (DmcUpdateModel val);
